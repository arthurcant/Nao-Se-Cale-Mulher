        ...
        <div className='w-full'>
            ...
            <div className="bg-[#FFDEF6]">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between shadow-xl bg-[#FFDEF6]">
                    <div className="ml-7 border-solid border-2 rounded-lg shadow-xl lg:p-20 p-10 pt-10 mt-20 bg-white">

                    <div className="border-solid border-2 p-20 m-5 shadow-xl"></div>
                        ...
                        <div className="border-solid border-2 p-20 mb-5 shadow-xl ml-5 "></div>
                    ...
                    <div className="p-10 bg-[#FFDEF6]"></div>
                        ...
                        <div className=" bg-white border-solid border-2 shadow-xl rounded-lg lg:p-14 p-5 pt-10 mr-10">
